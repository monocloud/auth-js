...
> **OnSetApplicationState** = (`req`: [`MonoCloudRequest`](/sdks/nextjs/api-reference/types/monocloudrequest)) => `Promise`\<[`ApplicationState`](/sdks/nextjs/api-reference/types/applicationstate)\> \| [`ApplicationState`](/sdks/nextjs/api-reference/types/applicationstate)
...
| --------- | ------------------------------------------------------------------------------- | ----------------------------------------------- |
| `req`     | [`MonoCloudRequest`](/sdks/nextjs/api-reference/types/monocloudrequest) | The incoming request initiating authentication. |

## Returns

`Promise`\<[`ApplicationState`](/sdks/nextjs/api-reference/types/applicationstate)\> \| [`ApplicationState`](/sdks/nextjs/api-reference/types/applicationstate)
