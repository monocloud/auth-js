...
category: Classes
description: "MonoCloudOidcClient is a class in the MonoCloud Node.js SDK."
---
...
> **deviceAuthorizationGrant**(`deviceCode`: `string`): `Promise`\<[`Tokens`](/sdks/nodejs/api-reference/types/tokens)\>
...
[MonoCloudOPError](/sdks/nodejs/api-reference/error-classes/monocloudoperror) - When the authorization server returns a standardized
OAuth 2.0 error response.
