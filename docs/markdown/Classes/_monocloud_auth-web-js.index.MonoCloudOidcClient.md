...
[MonoCloudTokenError](/sdks/web-js/api-reference/error-classes/monocloudtokenerror) - If Logout Token validation fails

#### Throws

[MonoCloudHttpError](/sdks/web-js/api-reference/error-classes/monocloudhttperror) - Thrown if there is a network error while fetching the issuer metadata or JWKS.
