...
- `Partial`\<`Omit`\<[`MonoCloudSessionOptionsBase`](/sdks/nextjs/api-reference/types/monocloudsessionoptionsbase), `"store"` \| `"cookie"`\>\>

## Properties

| Property                                        | Type                                                                                            | Description                                                                                                                                                                                                                             |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cookie?`                   | `Partial`\<[`MonoCloudCookieOptions`](/sdks/nextjs/api-reference/types/monocloudcookieoptions)\> | Session cookie settings.                                                                                                                                                                                                                |
...
| `store?`                     | [`MonoCloudSessionStore`](/sdks/nextjs/api-reference/types/monocloudsessionstore)                | A custom session store implementation. When provided, sessions are persisted using this store instead of cookies-only storage.                                                                                                          |
