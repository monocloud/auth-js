...
- [`UserinfoResponse`](/sdks/react/api-reference/types/userinforesponse).[`JwtClaims`](/sdks/nodejs/api-reference/types/jwtclaims)
...
| `address?`                             | [`Address`](/sdks/react/api-reference/types/address) | Postal address.                                                                                               |
...
| `groups?`                               | [`Group`](/sdks/react/api-reference/types/group)[]   | Group memberships for the user.                                                                               |
