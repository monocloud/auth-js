...
- [`UserinfoResponse`](/sdks/nextjs/api-reference/types/userinforesponse).[`JwtClaims`](/sdks/nodejs/api-reference/types/jwtclaims)
...
| `address?`                             | [`Address`](/sdks/nextjs/api-reference/types/address) | Postal address.                                                                                               |
