...
| `codeChallengeMethod?` | [`CodeChallengeMethod`](/sdks/nextjs/api-reference/enums/codechallengemethod) | Method used to generate the PKCE code challenge.                                                                                                                         |
...
| `responseMode?`               | [`ResponseModes`](/sdks/nextjs/api-reference/enums/responsemodes)             | Specifies how the authorization response is returned to the client.                                                                                                      |
| `responseType?`               | [`ResponseTypes`](/sdks/nextjs/api-reference/enums/responsetypes)             | Determines which artifacts are returned from the authorization endpoint.                                                                                                 |
