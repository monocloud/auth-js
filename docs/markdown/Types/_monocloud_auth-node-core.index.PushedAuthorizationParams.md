...
This type mirrors [AuthorizationParams](/sdks/nodejs-core/api-reference/types/authorizationparams) but excludes `requestUri`,
...
- `Omit`\<[`AuthorizationParams`](/sdks/nodejs-core/api-reference/types/authorizationparams), `"requestUri"`\>
