...
| `appState?`                   | [`ApplicationState`](/sdks/web-js/api-reference/types/applicationstate)                  | Custom application state preserved across the authentication round-trip. The value is provided to the [OnSessionCreating](/sdks/web-js/api-reference/handler-types/onsessioncreating) hook when the session is constructed. |
| `authenticatorHint?` | [`Authenticators`](/sdks/web-js/api-reference/enums/authenticators)   | Specifies the preferred authenticator or identity provider to use for sign-in.                                                                                                                                                          |
...
| `mode?`                           | [`InteractionMode`](/sdks/web-js/api-reference/enums/interactionmode) | Determines the interaction mode for the sign-in flow.                                                                                                                                                                                   |
| `prompt?`                       | [`Prompt`](/sdks/web-js/api-reference/enums/prompt)                   | Specifies the desired authentication interaction behavior.                                                                                                                                                                              |
