...
> **DefaultAuthParams** = `Pick`\<[`AuthorizationParams`](/sdks/web-js/api-reference/types/authorizationparams), `"scopes"` \| `"resource"` \| `"responseType"` \| `"prompt"` \| `"display"` \| `"uiLocales"` \| `"acrValues"` \| `"maxAge"` \| `"loginHint"` \| `"authenticatorHint"`\>
