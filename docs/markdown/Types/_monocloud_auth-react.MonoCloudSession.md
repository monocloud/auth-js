...
| ------------------------------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `accessTokens?`         | [`AccessToken`](/sdks/react/api-reference/types/accesstoken)[]   | Access tokens associated with the session. Multiple tokens may exist when access tokens are issued for different resources or scope sets. |
...
| `user`                          | [`MonoCloudUser`](/sdks/react/api-reference/types/monoclouduser) | The authenticated user profile, typically derived from ID token claims and/or the `UserInfo` endpoint.                                    |
