...
category: Types
description: "Options for configuring protectPage() in the App Router."
---

# Type: ProtectAppPageOptions

Options for configuring [protectPage()](/sdks/nextjs/api-reference/functions/protectpage) in the App Router.
