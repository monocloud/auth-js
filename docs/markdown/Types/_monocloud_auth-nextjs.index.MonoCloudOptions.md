...
| `clientSecret?`                         | `string` \| [`Jwk`](/sdks/nextjs/api-reference/types/jwk)                                                                                                                             | Client secret used for confidential clients.                                                                                                                                                                                                    |
...
| `jwksResolver?`                         | () => [`Jwks`](/sdks/nextjs/api-reference/types/jwks) \| `Promise`\<[`Jwks`](/sdks/nextjs/api-reference/types/jwks)\>                                                                  | Optional custom resolver for the JSON Web Key Set (JWKS).                                                                                                                                                                                       |
| `metadataCacheDuration?`       | `number`                                                                                                                                                                             | Duration (in seconds) to cache OpenID discovery metadata.                                                                                                                                                                                       |
| `metadataResolver?`                 | () => [`IssuerMetadata`](/sdks/nextjs/api-reference/types/issuermetadata) \| `Promise`\<[`IssuerMetadata`](/sdks/nextjs/api-reference/types/issuermetadata)\>                          | Optional custom resolver for the issuer metadata.                                                                                                                                                                                               |
