...
- [`UserinfoResponse`](/sdks/web-js/api-reference/types/userinforesponse).[`JwtClaims`](/sdks/nodejs/api-reference/types/jwtclaims)
...
| `address?`                             | [`Address`](/sdks/web-js/api-reference/types/address) | Postal address.                                                                                               |
...
| `groups?`                               | [`Group`](/sdks/web-js/api-reference/types/group)[]   | Group memberships for the user.                                                                               |
