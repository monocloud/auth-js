...
This object extends [AccessToken](/sdks/nextjs/api-reference/types/accesstoken) and includes additional tokens issued during authentication, along with convenience metadata used by the SDK to indicate token validity.
