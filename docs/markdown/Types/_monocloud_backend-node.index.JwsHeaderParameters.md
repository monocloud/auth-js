...
| ------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `alg`    | [`SecurityAlgorithms`](/sdks/nodejs/api-reference/enums/securityalgorithms) | The cryptographic algorithm used to sign the token.                                                  |
| `crit?` | `string`[]                                                                                  | List of header parameters that are marked as critical and must be understood by the token processor. |
| `jwk?`   | [`Jwk`](/sdks/nodejs-backend/api-reference/types/jwk)                                               | An embedded JSON Web Key (JWK) containing the signing key.                                           |
