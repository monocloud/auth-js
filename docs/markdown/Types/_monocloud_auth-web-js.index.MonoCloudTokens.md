...
Extends [AccessToken](/sdks/web-js/api-reference/types/accesstoken) with the ID token, refresh token, and a convenience flag indicating whether the access token has expired.
