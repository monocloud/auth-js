...
| `jwks?`                                             | [`Jwks`](/sdks/nodejs-backend/api-reference/types/jwks) | Pre-fetched JSON Web Key Set to use for signature verification instead of fetching from the server. |
