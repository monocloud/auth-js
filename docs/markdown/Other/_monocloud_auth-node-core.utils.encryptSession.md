...
> **encryptSession**(`session`: [`MonoCloudSession`](/sdks/nodejs-core/api-reference/types/monocloudsession), `secret`: `string`, `ttl?`: `number`): `Promise`\<`string`\>
...
| --------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `session` | [`MonoCloudSession`](/sdks/nodejs-core/api-reference/types/monocloudsession) | The session object to encrypt.                                     |
