...
> **encryptSession**(`session`: [`MonoCloudSession`](/sdks/js-core/api-reference/types/monocloudsession), `secret`: `string`, `ttl?`: `number`): `Promise`\<`string`\>
...
| --------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `session` | [`MonoCloudSession`](/sdks/js-core/api-reference/types/monocloudsession) | The session object to encrypt.                                     |
