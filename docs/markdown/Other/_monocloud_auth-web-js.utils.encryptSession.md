...
> **encryptSession**(`session`: [`MonoCloudSession`](/sdks/web-js/api-reference/types/monocloudsession), `secret`: `string`, `ttl?`: `number`): `Promise`\<`string`\>
...
| --------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `session` | [`MonoCloudSession`](/sdks/web-js/api-reference/types/monocloudsession) | The session object to encrypt.                                     |
