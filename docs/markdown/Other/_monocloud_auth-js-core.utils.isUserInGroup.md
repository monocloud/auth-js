...
> **isUserInGroup**(`user`: [`MonoCloudUser`](/sdks/js-core/api-reference/types/monoclouduser) \| [`IdTokenClaims`](/sdks/js-core/api-reference/types/idtokenclaims), `groups`: `string`[], `groupsClaim`: `string`, `matchAll`: `boolean`): `boolean`
...
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `user`        | [`MonoCloudUser`](/sdks/js-core/api-reference/types/monoclouduser) \| [`IdTokenClaims`](/sdks/js-core/api-reference/types/idtokenclaims) | The user.                                                                                                                    |
