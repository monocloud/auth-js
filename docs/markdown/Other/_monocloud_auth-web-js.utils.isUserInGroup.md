...
> **isUserInGroup**(`user`: [`MonoCloudUser`](/sdks/web-js/api-reference/types/monoclouduser) \| [`IdTokenClaims`](/sdks/web-js/api-reference/types/idtokenclaims), `groups`: `string`[], `groupsClaim?`: `string`, `matchAll?`: `boolean`): `boolean`
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| `user`        | [`MonoCloudUser`](/sdks/web-js/api-reference/types/monoclouduser) \| [`IdTokenClaims`](/sdks/web-js/api-reference/types/idtokenclaims) | The user.                                                                                                                    |
