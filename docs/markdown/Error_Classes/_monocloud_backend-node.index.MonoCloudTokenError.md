...
> **new MonoCloudTokenError**(`message?`: `string`, `code?`: [`MonoCloudTokenErrorCode`](/sdks/nodejs-backend/api-reference/enums/monocloudtokenerrorcode)): `MonoCloudTokenError`
